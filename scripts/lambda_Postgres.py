...
def lambda_handler(event, context):
    ...
    print(datos_query)
    postgres_insert_query = "'INSERT INTO pelicula(id_pelicula,nombre_pelicula,fecha_lanzamiento,popularidad,sinopsis,origen,api,cloudWatch,fecha_consulta,fecha_carga) VALUES ("+ datos_query + ")"
